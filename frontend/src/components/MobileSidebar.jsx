...
const MobileSidebar = ({ isOpen, setIsOpen, user, theme, Logout }) => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed bottom-0 left-0 right-0 h-auto max-h-[85vh] bg-white dark:bg-gray-900 z-50 rounded-t-3xl shadow-2xl transform transition-transform duration-300 ease-out ${isOpen ? "translate-y-0" : "translate-y-full"
                    }`}
            >
                {/* Drag indicator */}
                ...
                <div className="py-2 max-h-[60vh] overflow-y-auto">
                    ...
                    >
                        ...
                        {/* Android switch */}
                        <div className={`w-11 h-6 rounded-full transition-colors duration-200 ${theme === "dark" ? "bg-blue-500" : "bg-gray-300 dark:bg-gray-600"
                            }`}>
                            <div className={`w-5 h-5 rounded-full bg-white shadow-md transform transition-transform duration-200 m-0.5 ${theme === "dark" ? "translate-x-5" : "translate-x-0"
                                }`} />
                        </div>
                    </button>
                </div>
